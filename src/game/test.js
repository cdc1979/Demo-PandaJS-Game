...
.body(function () {
    ...
    game.createClass('Block', {
        ...
        init: function (x, y) {
            ...
            this.body.options = { sprite: this.sprite };
    ...
    game.createScene('Main', {
        ...
        init: function () {
            ...
            this.world = new game.World({ gravity: [0, 6] });

            this.world.on("beginContact", function (event) {

                if (event.shapeB.collisionGroup == BALL && event.shapeA.collisionGroup == BLOCK) {
                    console.log(event.shapeA.collisionGroup);
                    console.log(event.shapeB.collisionGroup);
                    //game.scene.removeObject(event.shapeA);
                    //game.scene.removeObject(event.shapeB);
                    //game.scene.removeObject(event.bodyA);
            ...
            //this.world.p2.setImpactEvents(true);
